      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex items-center justify-between pt-5 border-t border-gray-100">
          <div className="flex flex-col">
            ...
            <span className="text-xl font-bold text-[#4A2B23] flex items-center">
          ...
          <button
            ...
            className="bg-[#4A2B23] whitespace-nowrap text-white hover:bg-[#F6971E] font-bold text-sm px-4 py-2.5 rounded-full transition-colors flex items-center gap-2 shadow-sm"
          >
